...
export const contents: Chunk[][] = [
  ...
  [
    { type: "h1", content: "인문대학 체육대회 참가신청이 시작되었습니다!" },
    {
      type: "strong",
      content: "해당 게시물 공유시 홍보이벤트에 참여하실 수 있습니다!",
    },
    { type: "p", content: "일시: 2023.07.28" },
    { type: "p", content: "장소: 서울대학교 대운동장" },
    { type: "p", content: "방법: 7월 15일까지 아래의 구글폼 작성" },
    { type: "p", content: "https://forms.gle/qAoDsV2EoFUv7wAX7" },
    { type: "p", content: ": ❗ 축구, 피구, 줄다리기, 줄넘기, 판뒤집기, 계주" },
    { type: "p", content: "❗ 점심 도시락 및 응원 도구 제공" },
    { type: "p", content: "❗ 체육대회 TF에서 운영하는 부스와 이벤트" },
    {
      type: "p",
      content: "❗ 참가 인원 및 성비를 고려하여 2반/4반 단위로 한 팀 구성",
    },
    {
      type: "p",
      content: "인문대학 체육대회에 많은 관심 부탁드립니다!",
    },
    {
      type: "p",
      content: "문의 : 체육대회 TF장 박유나(010-5247-6132)",
    },
    {
      type: "p",
      content: "[게시물 관리자: 학생회장 김철진]",
    },
  ],
  [
    {
      type: "h1",
      content: "[2023 기표와 기의 단독 공연 '기:승전결' 홍보]",
    },
